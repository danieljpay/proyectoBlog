    ...
    <div class="post">
        ...
        <div class="post_container">
            <div class="post_container-imagen">
                <img src="<?php echo URL_PROTOCOL.URL_CMS.'/storage/uploads'.$post->image->path; ?>" alt="Doctor Jacinto Herrera posando para una foto sosteniendo una medalla">
            </div>
        ...
        <div class="comments_container" id="c_cont">
            ...
            <div>
                ...
                <div class="comment_containt">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean eget dui condimentum, euismod turpis euismod, ultricies mauris. Etiam condimentum egestas massa facilisis feugiat. Sed dapibus justo in ipsum posuere aliquet. </p>
        ...
        <div class="comments_container" id="commentAdder">
            <div>
                ...
                <div class="comment_containt">
                    ...
                    <div contenteditable class="fake-textarea" id="fakeTextArea" oninput="document.querySelector('#commentAreaInvisible').textContent = this.innerText"></div>
                    <!-- Real y oculto -->
                    <textarea id="commentAreaInvisible"></textarea>
                </div>
                <div>
                    <input type="button" value="Enviar" name="sendCommentButton" id="sendCommentButton" onclick="javascript:addComment()">
                </div>
            </div>
